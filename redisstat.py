...
class StatCounter(object):
    ...
    def getResult(self):
        self.results['top_keys'] = self._top_n(self.keys)
        self.results['top_commands'] = self._top_n(self.commands)
        self.results['commands_time'] = self._time_stats(self.times)
        self.results['heaviest_commands'] = self._heaviest_commands(self.times)
        self.results['slowest_commands'] = self._slowest_commands(self.times)
        return self.results
